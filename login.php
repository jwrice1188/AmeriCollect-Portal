...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  foreach ($result as $theresult) {
    ...
    $sessiontokens = $theresult['tokens'];

    if($sessiontokens < 1){
      ?>
        <script type="text/javascript">
        window.location = "login-fail.php";
        </script>
      <?
    }
  }
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      ?>
      <h1>Please Login</h1>
      <h5>Don't know your login information? Please talk with your supervisor.</h5>
...
<?php include("includes/scripts.php.php"); ?>
