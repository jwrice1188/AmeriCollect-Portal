...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <a class="navbar-brand js-scroll-trigger" href="index.php">
      <span class="d-block d-lg-none">Game Hub</span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        ?>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="games.php">Games</a>
          </li>
        <?php
        } ?>
        ...
        ?>
          <li class="nav-item">
            <a class="admin nav-link js-scroll-trigger" href="admin.php">Admin</a>
          </li>
        <?php
        } ?>
